...
const DRIVE_FOLDER_NAME = "JAMOrcamentos";
const DRIVE_BACKUP_NAME = "jamorc-backup.json.gz";
const DRIVE_BASE_NAME = "jamorc-base.json.gz";
const DRIVE_CLIENTS_NAME = "jamorc-clientes.json.gz";
const DRIVE_PROJECT_PREFIX = "jamorc-projeto-";
const DRIVE_PROJECT_SUFFIX = ".json.gz";
const DRIVE_STORAGE_VERSION = 2;
const DRIVE_REQUEST_TIMEOUT_MS = 60_000;
const CLIENT_ID_KEY = "jamorc-google-client-id";
